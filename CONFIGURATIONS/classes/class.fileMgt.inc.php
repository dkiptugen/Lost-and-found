...
class fileMgt
   {
    function upload($name,$target_dir,$maxsize=500000,$sub,$allowed_type=array("jpg","png","jpeg","gif","pdf","docx","doc"))
       {
		 ...
		 if ($uploadOk == 0)
	        {
              ...
              return "../../INCLUDES/USER_IMAGES/images.jpeg";
            } 
	    else 
	        {
               if (move_uploaded_file($_FILES[$name]["tmp_name"], $target_file))
	               {
                      return "../../INCLUDES/USER_IMAGES/".$sub."/". basename( $_FILES[$name]["name"]);
